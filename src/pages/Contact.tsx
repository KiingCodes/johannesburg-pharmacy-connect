...
const Contact = () => (
  <>
    <PageHeader title="Contact Us" subtitle="We'd love to hear from you. Reach out via any of the channels below." />
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
          ...
          {/* Map */}
          <div className="overflow-hidden rounded-lg border animate-fade-in-up opacity-0" style={{ animationDelay: "0.3s" }}>
            <iframe
